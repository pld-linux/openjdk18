...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk18-jdk < 18.0.2.1-2
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk18-jdk-base < 18.0.2.1-2
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk18-jre < 18.0.2.1-2
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk18-jre-base < 18.0.2.1-2
...
Obsoletes:	openjdk18-jre-base-X11 < 18.0.2.1-2
...
Obsoletes:	openjdk18-jre-base-freetype < 18.0.2.1-2
...
Obsoletes:	jar
Obsoletes:	openjdk18-jar < 18.0.2.1-2
